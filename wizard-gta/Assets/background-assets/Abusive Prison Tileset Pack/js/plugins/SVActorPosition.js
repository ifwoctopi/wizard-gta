 ...
 * プラグインコマンドの書式:
 * SVActorPosition arg0 arg1 arg2
 * arg0 は '1', '2', '3', か '4', '5', '6' にします。
 * arg1 は 'X' か 'Y' にします。
 * arg2 は 座標の値にします。
 * ex.
 * SVActorPosition 1 X 1100    # SV画面のアクター1のX座標を640にします。
...
(function() {
  ...
  var SVActor1X = Number(parameters['actor1 Xpos'] || 110);
  var SVActor2X = Number(parameters['actor2 Xpos'] || 280);
  var SVActor3X = Number(parameters['actor3 Xpos'] || 450);
  var SVActor4X = Number(parameters['actor4 Xpos'] || 620);
  var SVActor5X = Number(parameters['actor5 Xpos'] || 790);
  var SVActor6X = Number(parameters['actor6 Xpos'] || 960);
  var SVActor1Y = Number(parameters['actor1 Ypos'] || 440);
  var SVActor2Y = Number(parameters['actor2 Ypos'] || 440);
  var SVActor3Y = Number(parameters['actor3 Ypos'] || 440);
  var SVActor4Y = Number(parameters['actor4 Ypos'] || 440);
  var SVActor5Y = Number(parameters['actor5 Ypos'] || 440);
  var SVActor6Y = Number(parameters['actor6 Ypos'] || 440);
  ...
  Game_Interpreter.prototype.pluginCommand = function(command, args) {
    ...
    if (command === 'SVActorPosition') {
      ...
      if(value){
		...
		case '5':
          if(args[1] === 'x' || args[1] === 'X'){
            $gameSystem.svActorX[4] = value;
          } else if(args[1] === 'y'|| args[1] === 'Y'){
            $gameSystem.svActorY[4] = value;
          }
          break;
        case '6':
          if(args[1] === 'x' || args[1] === 'X'){
            $gameSystem.svActorX[5] = value;
          } else if(args[1] === 'y'|| args[1] === 'Y'){
            $gameSystem.svActorY[5] = value;
          }
        }
      }
    }
  ...
  Game_System.prototype.defineSvActorArray = function() {
    this.svActorX = [null, null, null, null, null, null];
    this.svActorY = [null, null, null, null, null, null];
  };
  ...
  Sprite_Actor.prototype.setActorHome = function(index) {
    ...
    case 3:
	  ...
	  break;
	case 4:
      x = $gameSystem.svActorX[4] || SVActor5X;
      y = $gameSystem.svActorY[4] || SVActor5Y;
	  break;
	case 5:
      x = $gameSystem.svActorX[5] || SVActor6X;
      y = $gameSystem.svActorY[5] || SVActor6Y;
    }
    // set position
    this.setHome(x, y);
  };
