...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*:
 * @plugindesc v1.03 Silv KeyMapper <SilvKeys>
 * @author Silver
 *
 * @help
 * Example usage:
...
var Silv = Silv || {};
if (!('SILV_Keys' in Imported) || Imported.SILV_Keys < 1.03) {
	Imported.SILV_Keys = 1.03;
	Silv.Keys = Silv.Keys || {};
...
/*// Example usage (press home-key and watch console window):

// example debug key
var myKey = Silv.Keys.fromStringParam('home');
